...
The example below shows how to create a pipeline, read JPEG images, perform certain augmentations on them, and show the output using OpenCV by utilizing `C++ API <https://github.com/ROCm/rocAL/blob/develop/tests/cpp_api_tests/image_augmentation/image_augmentation.cpp#L103>`_.
...
To see a sample image augmentation application in C++, see `Image Augmentation <https://github.com/ROCm/rocAL/tree/develop/tests/cpp_api_tests/image_augmentation>`_. 
