...
6. Run the training as shown [here](https://github.com/ROCm/MIVisionX/tree/develop/rocAL/docs/examples/pytorch).

To see a sample training script, click [here](https://github.com/ROCm/MIVisionX/tree/develop/rocAL/docs/examples/pytorch). 
